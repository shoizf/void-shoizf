...
$ visudo
#    Inside the editor, find the line '# %wheel ALL=(ALL) ALL' and remove the '# ' from the start of that line. Then save and exit.
#
...
# Or you could manually open it with $EDITOR and add the lines manually.
  ...
  # Type in "nvidia-drm.modeset-1" to the end of the "GRUB_CMDLINE_LINUX_DEFAULT="loglevel=4"" line.  
...
$ lsmod | grep nouveau
# No output expected if succeeded. 
$ nvidia-smi
# Expect output if succeeded
